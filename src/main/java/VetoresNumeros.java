 ...
 * - todo array possui a propriedade lenght, que indica a quantidade de elementos armazenados;
 */
...
public class VetoresNumeros {
    ...
    public static void main(String [] args) {
        ...
        //o Java define o comando for each, mais simples de iterar sob elementos do array
        for (float n: notas) {
            //nesse caso não existe uma váriavel de controle (índice)
            System.out.print(n+ ", ");
